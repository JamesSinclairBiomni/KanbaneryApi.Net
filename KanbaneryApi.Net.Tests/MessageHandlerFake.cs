...
{
    internal class MessageHandlerFake : HttpMessageHandler
    {
        ...
        protected virtual string GetResponseContent(Uri uri)
        {
            ...
            var assembly = typeof(MessageHandlerFake).Assembly;
            string resourceName = "KanbaneryApi.Net.Tests.ApiResponses." + path + ".json";
